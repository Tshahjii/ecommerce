            ...
            <div class="page-title-box d-sm-flex align-items-center justify-content-between bg-galaxy-transparent">
                ...
                <div class="page-title-right">
                    <ol class="breadcrumb m-0">
                        ...
                        <li class="breadcrumb-item"><a href="{{ route('childcategory') }}">Child Category</a></li>
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <div class="live-preview">
                        <form action="{{ route('childcategory-bulk-upload') }}" method="POST" autocomplete="off"
                                ...
                                <div class="col-md-12">
                                    <div class="mb-3">
                                        <div class="d-flex align-items-center justify-content-between mb-2">
                                            ...
                                            <a href="{{ route('childcategory-sheet') }}" class="small">Download Spread
                                                sheet</a>
                                        </div>
                ...
                <div class="d-flex ms-2">
                    ...
                    <div class="flex-grow-1">
                        ...
                        <ul class="text-muted vstack gap-2">
                            ...
                            <li>
                                Child Category,Slug,category & Status(if category show in sidebar of menu) should
    ...
    @if (session()->has('failures'))
        <div class="row">
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-header align-items-center d-flex">
                        <h5 class="card-title mb-0 flex-grow-1 text-danger">Rejected Child Categories</h5>
                    </div>
                    <div class="card-body">
