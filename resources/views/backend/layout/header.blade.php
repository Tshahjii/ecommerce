              ...
              <div class="d-flex">
                  ...
                  <div class="navbar-brand-box horizontal-logo">
                      ...
                      <a href="index.html" class="logo logo-light">
                          ...
                          <span class="logo-lg">
                              <img src="{{ asset('frontend/assets/img/logo_light.png') }}" alt=""
                                  height="50">
                          </span>
                      </a>
                  </div>
              ...
              <div class="d-flex align-items-center">
                  ...
                  <div class="dropdown ms-1 topbar-head-dropdown header-item">
                      <button type="button"
                          ...
                          <img id="header-lang-img" src="{{ asset('/backend/assets/images/flags/india.webp') }}"
                      ...
                      <div class="dropdown-menu dropdown-menu-end">
                          ...
                          <a href="javascript:void(0);" class="dropdown-item notify-item language py-2"
                              ...
                              <img src="{{ asset('/backend/assets/images/flags/india.webp') }}" alt="user-image"
                      ...
                      <button type="button" class="btn material-shadow-none" id="page-header-user-dropdown"
                          ...
                          <span class="d-flex align-items-center">
                              ...
                              <span class="text-start ms-xl-2">
                                  ...
                                  @endphp
                                  <span
                                      class="d-none d-xl-inline-block ms-1 fw-medium user-name-text">{{ $user->name ?? ($user->mobile ?? '') }}</span>
                                  <span
