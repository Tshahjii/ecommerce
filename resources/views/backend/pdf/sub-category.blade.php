        ...
        <tbody>
            ...
            @foreach ($data as $sub_category)
                <tr>
                    ...
                    <td>{{ $sub_category->childCategory->child_category ?? '-' }}</td>
                    <td>
                        @php
                            $img_path = !empty($sub_category->img_path)
                                ? public_path('backend/upload/image/sub-category/' . $sub_category->img_path)
                    ...
                    <td>
                        ...
                        @elseif ($sub_category->status == 'inactive')
