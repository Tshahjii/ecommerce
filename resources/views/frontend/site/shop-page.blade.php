                ...
                <div class="col-lg-6 my-2">
                    <ol class="breadcrumb m-0 small justify-content-center justify-content-lg-end">
                        <li class="breadcrumb-item">
                            <a class="text-nowrap text-reset" href="#"><i class="fa-sharp fa-regular fa-house"></i>&nbsp;Home /</a>
                        </li>
                        <li class="text-nowrap active" aria-current="page">
                            &nbsp;Product
                        </li>
                    </ol>
                </div>
        ...
        <div class="container">
            <div class="shop-clear-filter-01">
                <ul class="list-unstyled">
                    <li>
                        <a class="clear-all" href="#">Clear All <i class="bi-x"></i></a>
                    </li>
                    <li>
                        <a href="#">Man <i class="bi-x"></i></a>
                    </li>
                    <li>
                        <a href="#">Women <i class="bi-x"></i></a>
                    </li>
                    <li>
                        <a href="#">Yellow <i class="bi-x"></i></a>
                    </li>
                </ul>
            </div>
            <div class="row">
                ...
                <div class="col shop-sidebar-option-03 offcanvas-lg offcanvas-start px-0 px-lg-3" tabindex="-1"
                    ...
                    <div class="offcanvas-header border-bottom">
                        <h5 class="offcanvas-title" id="shop_filterLabel">
                            Shop Filter
                        </h5>
                        <button type="button" class="btn-close" data-bs-dismiss="offcanvas" data-bs-target="#shop_filter"
                                    ...
                                    <ul class="nav flex-column">
                                        ...
                                        <li class="nav-item">
                                            ...
                                            <div class="collapse" id="shop_cat_1">
                                                <ul class="nav nav-pills flex-column nav-hierarchy">
                                                    ...
                                                    <li class="nav-item">
                                                        <a href="#" class="nav-link">Sports &amp; Active
                                                            Wear</a>
                                                    </li>
                                                </ul>
                                            </div>
                                        ...
                                        <li class="nav-item">
                                            ...
                                            <div class="collapse" id="shop_cat_2">
                                                <ul class="nav nav-pills flex-column nav-hierarchy">
                                                    <li class="nav-item">
                                                        <a href="#" class="nav-link">Indian &amp; Fusion
                                                            Wear</a>
                                                    </li>
                                                    <li class="nav-item">
                                                    ...
                                                    <li class="nav-item">
                                                        <a href="#" class="nav-link">Beauty &amp; Personal
                                                            Care</a>
                                                    </li>
                                                </ul>
                                            </div>
                                        ...
                                        <li class="nav-item">
                                            ...
                                            <a data-bs-toggle="collapse" href="#shop_cat_3" role="button"
                                                aria-expanded="false" aria-controls="shop_cat_3" class="s-icon"></a>
                                        ...
                                        <li class="nav-item">
                                            ...
                                            <a data-bs-toggle="collapse" href="#shop_cat_4" role="button"
                                                aria-expanded="false" aria-controls="shop_cat_4" class="s-icon"></a>
                                            <div class="collapse" id="shop_cat_4">
                                                <ul class="nav nav-pills flex-column nav-hierarchy">
                                                    <li class="nav-item">
                                                        <a href="#" class="nav-link">Bed Linen &amp;
                                                            Furnishing</a>
                                                    </li>
                                                    <li class="nav-item">
                                ...
                                <div class="shop-attr-body">
                                    <ul class="list-unstyled">
                                        <li class="custom-radio">
                                            <input class="custom-control-input" id="gen1" type="radio"
                                                name="Gender" checked="checked" />
                                            <label class="custom-control-label" for="gen1">Men</label>
                                        </li>
                                        <li class="custom-radio">
                                            <input class="custom-control-input" id="gen2" type="radio"
                                                name="Gender" />
                                            <label class="custom-control-label" for="gen2">Women</label>
                                        </li>
                                        <li class="custom-radio">
                                            <input class="custom-control-input" id="gen3" type="radio"
                                                name="Gender" />
                                            <label class="custom-control-label" for="gen3">Boys</label>
                                        </li>
                                        <li class="custom-radio">
                                            <input class="custom-control-input" id="gen4" type="radio"
                                                name="Gender" />
                                ...
                                <div class="shop-attr-body">
                                    <ul class="list-unstyled">
                                        <li class="custom-checkbox checkbox-color">
                                            <input class="custom-control-input" id="colorsidebar1" type="checkbox"
                                                checked="" />
                                            <label class="custom-control-label" style="color: #1f45fc"
                                                for="colorsidebar1"><span class="text-body">Royal
                                                    Blue</span></label>
                                        </li>
                                        <li class="custom-checkbox checkbox-color">
                                        ...
                                        <li class="custom-checkbox checkbox-color">
                                            <input class="custom-control-input" id="colorsidebar5" type="checkbox"
                                                disabled="" />
                                            <label class="custom-control-label" style="color: #17a2b8"
                                                for="colorsidebar5"><span class="text-body">Cyan</span></label>
                                        </li>
                                    </ul>
                                </div>
                            </div>
                                ...
                                <div class="shop-attr-body">
                                    <ul class="list-unstyled">
                                        <li class="custom-checkbox">
                                            ...
                                            <label class="custom-control-label" for="price1">$10.00 -
                                                $49.00</label>
                                        </li>
                                        <li class="custom-checkbox">
                                            <input class="custom-control-input" id="price2" type="checkbox" />
                                            <label class="custom-control-label" for="price2">$50.00 -
                                                $99.00</label>
                                        </li>
                                        <li class="custom-checkbox">
                                            <input class="custom-control-input" id="price3" type="checkbox" />
                                            <label class="custom-control-label" for="price3">$100.00 -
                                                $199.00</label>
                                        </li>
                                        <li class="custom-checkbox">
                                            <input class="custom-control-input" id="price4" type="checkbox" />
                                            <label class="custom-control-label" for="price4">$200.00 and
                                                Up</label>
                                        </li>
                                    </ul>
                                    <div class="d-flex align-items-center pt-3">
                                        <!-- Input -->
                                        <input type="number" class="form-control form-control-sm" placeholder="$10.00"
                                            min="10" /><!-- Divider -->
                                        <div class="text-gray-350 mx-2">‒</div>
                                        <!-- Input -->
                                        <input type="number" class="form-control form-control-sm" placeholder="$350.00"
                                            max="350" />
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="shop-top-bar-03 d-flex">
                        <div class="layout-change">
                            ...
                            <button class="btn btn-sm d-lg-none" type="button" data-bs-toggle="offcanvas"
                                ...
                                <i class="fs-4 lh-1 bi bi-justify-left"></i></button><!-- End Mobile Toggle -->
                            <a class="btn btn-sm active" href="{{ route('shop-page') }}"><i class="bi bi-grid"></i></a>
                            <a class="btn btn-sm" href="{{ route('shop-full-page') }}"><i
                                ...
                                <div class="product-card-image">
                                    ...
                                    <div class="product-action">
                                        <a href="#" class="btn btn-dark"><i
                                                class="fa-sharp fa-regular fa-heart"></i> </a><a href="#"
                                            class="btn btn-dark"><i class="fa-solid fa-repeat"></i> </a><a
                                            ...
                                            class="btn btn-dark"><i class="fa-regular fa-cart-shopping-fast"></i></a>
                                    </div>
                                    <div class="product-media">
                                        <a href="#"><img class="img-fluid"
                                                src="{{ asset('frontend/assets/img/fashion3/product-11.jpg') }}"
                                                title="" alt="" /></a>
                                    </div>
                                </div>
                        ...
                        <div class="col-6 col-md-3 col-lg-4">
                            <div class="product-card-3">
                                <div class="product-card-image">
                                    ...
                                    <div class="product-media">
                                        <a href="#"><img class="img-fluid"
                                                src="{{ asset('frontend/assets/img/fashion3/product-12.jpg') }}"
                                                title="" alt="" /></a>
                                    </div>
                                </div>
                                <div class="product-card-info">
                        ...
                        <div class="col-6 col-md-3 col-lg-4">
                            <div class="product-card-3">
                                <div class="product-card-image">
                                    ...
                                    <div class="product-media">
                                        <a href="#"><img class="img-fluid"
                                                src="{{ asset('frontend/assets/img/fashion3/product-13.jpg') }}"
                                                title="" alt="" /></a>
                                    </div>
                                </div>
                                <div class="product-card-info">
                        ...
                        <div class="col-6 col-md-3 col-lg-4">
                            <div class="product-card-3">
                                <div class="product-card-image">
                                    ...
                                    <div class="product-media">
                                        <a href="#"><img class="img-fluid"
                                                src="{{ asset('frontend/assets/img/fashion3/product-14.jpg') }}"
                                                title="" alt="" /></a>
                                    </div>
                                </div>
                                <div class="product-card-info">
