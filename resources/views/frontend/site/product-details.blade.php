...
@section('content')
    ...
    <section class="product-details py-6">
        <div class="container">
            <div class="row align-items-start"><!-- Product Gallery -->
                <div class="col-lg-6 lightbox-gallery product-gallery sticky-lg-top">
                        ...
                        <div class="swiper-wrapper">
                            <div class="swiper-slide">
                                <div class="pd-gallery-slide"><a class="gallery-link"
                                        href="{{ asset('frontend/assets/img/fashion/product-x-1.jpg') }}"><i
                                            class="bi bi-arrows-fullscreen"></i></a> <img
                                        src="{{ asset('frontend/assets/img/fashion/product-x-1.jpg') }}" class="img-fluid"
                                        title="" alt=""></div>
                            </div>
                            <div class="swiper-slide">
                                <div class="pd-gallery-slide"><a class="gallery-link"
                                        href="{{ asset('frontend/assets/img/fashion/product-x-2.jpg') }}"><i
                                            class="bi bi-arrows-fullscreen"></i></a> <img
                                        src="{{ asset('frontend/assets/img/fashion/product-x-2.jpg') }}" class="img-fluid"
                                        title="" alt=""></div>
                            </div>
                            <div class="swiper-slide">
                                <div class="pd-gallery-slide"><a class="gallery-link"
                                        href="{{ asset('frontend/assets/img/fashion/product-x-3.jpg') }}"><i
                                            class="bi bi-arrows-fullscreen"></i></a> <img
                                        src="{{ asset('frontend/assets/img/fashion/product-x-3.jpg') }}" class="img-fluid"
                                        title="" alt=""></div>
                            </div>
                            <div class="swiper-slide">
                                <div class="pd-gallery-slide"><a class="gallery-link"
                                        href="{{ asset('frontend/assets/img/fashion/product-x-4.jpg') }}"><i
                                            class="bi bi-arrows-fullscreen"></i></a> <img
                                        src="{{ asset('frontend/assets/img/fashion/product-x-4.jpg') }}" class="img-fluid"
                                        title="" alt=""></div>
                            </div>
                            <div class="swiper-slide">
                                <div class="pd-gallery-slide"><a class="gallery-link"
                                        href="{{ asset('frontend/assets/img/fashion/product-x-5.jpg') }}"><i
                                            class="bi bi-arrows-fullscreen"></i></a> <img
                                        src="{{ asset('frontend/assets/img/fashion/product-x-5.jpg') }}" class="img-fluid"
                                        title="" alt=""></div>
                            </div>
                            <div class="swiper-slide">
                                <div class="pd-gallery-slide"><a class="gallery-link"
                                        href="{{ asset('frontend/assets/img/fashion/product-x-6.jpg') }}"><i
                                            class="bi bi-arrows-fullscreen"></i></a> <img
                                        src="{{ asset('frontend/assets/img/fashion/product-x-6.jpg') }}" class="img-fluid"
                                        title="" alt=""></div>
                            </div>
                        </div>
                    </div>
                    <div class="swiper swiper_thumb_gallery product-thumb">
                        <div class="swiper-wrapper">
                            ...
                            <div class="swiper-slide">
                                <div class="pd-gallery-slide-thumb"><img
                                        src="{{ asset('frontend/assets/img/fashion/product-x-5.jpg') }}"
                                        class="img-fluid" title="" alt=""></div>
                            </div>
                            <div class="swiper-slide">
                                <div class="pd-gallery-slide-thumb"><img
                                        src="{{ asset('frontend/assets/img/fashion/product-x-6.jpg') }}"
                                        class="img-fluid" title="" alt=""></div>
                            </div>
                        </div>
                ...
                <div class="col-lg-6 ps-lg-5 pt-5 pt-lg-0">
                    <div class="product-detail">
                        ...
                        <div class="rating-star text small pb-4"><i class="bi bi-star-fill active"></i> <i
                                ...
                                class="bi bi-star-fill active"></i> <i class="bi bi-star"></i> <small>(4 Reviews )</small>
                        </div>
                        ...
                        <div class="product-attribute"><label class="fs-6 text-mode pb-2 fw-500">Size</label>
                            <div class="nav-thumbs nav mb-3">
                                <div class="form-check radio-text form-check-inline me-2"><input class="form-check-input"
                                        type="radio" name="size_d3" id="xs_2" checked=""> <label
                                        class="radio-text-label" for="xs_2">XS</label></div>
                                <div class="form-check radio-text form-check-inline me-2"><input class="form-check-input"
                                        type="radio" name="size_d3" id="s_2"> <label class="radio-text-label"
                                        for="s_2">S</label></div>
                                <div class="form-check radio-text form-check-inline me-2"><input class="form-check-input"
                                        type="radio" name="size_d3" id="m_2"> <label class="radio-text-label"
                                        for="m_2">M</label></div>
                                <div class="form-check radio-text form-check-inline me-2"><input class="form-check-input"
                                        type="radio" name="size_d3" id="l_2"> <label class="radio-text-label"
                                        for="l_2">L</label></div>
                            </div><label class="fs-6 text-mode pb-2 fw-500">Color</label>
                            <div class="nav-thumbs nav mb-3">
                                <div class="form-check radio-color large form-check-inline me-2"><input
                                        class="form-check-input" type="radio" name="color_1" id="color_01"
                                        checked=""> <label class="radio-color-label" for="color_01"><span
                        ...
                        <div class="product-price fs-3 fw-500 mb-2"><del
                                class="text-muted fs-6">$38.<small>50</small></del>
                            <span class="text-primary">$28.<small>50</small></span>
                        </div>
                        <div class="product-detail-actions d-flex flex-wrap pt-3">
                            <div class="cart-qty me-3 mb-3">
                                <div class="dec qty-btn qty_btn">-</div><input class="cart-qty-input form-control"
                            ...
                            <div class="cart-button mb-3 d-flex"><button class="btn btn-mode me-3"><i
                                    ...
                                    class="btn btn-outline-mode me-3"><i class="fi-heart"></i></button> <button
                                    class="btn btn-outline-mode"><i class="fi-repeat"></i></button></div>
                        </div>
                        <div class="product-info-buttons nav pt-4"><a href="#" class="me-3"
                                data-bs-toggle="modal" data-bs-target="#px_size_chart_modal"><i
                                    class="bi bi-scissors"></i>Size guide</a> <a href="#" class=""
                                data-bs-toggle="modal" data-bs-target="#px_shipping_modal"><i
                                    class="bi bi-truck me-2"></i>Shipping</a> <a href="#" class="ms-auto"
                                data-bs-toggle="modal" data-bs-target="#px_ask_modal"><i
                                    class="bi bi-envelope ms-auto"></i>Ask about product</a></div>
                        <div class="pt-3 border-top mt-3 small">
                            <p class="theme-link mb-2"><label class="m-0 text-mode">Categories:</label> <a
                                    href="#">Sunglasses</a>, <a href="#">Winter</a>, <a
                                    href="#">Shorts</a>, <a href="#">Cool</a></p>
                            <p class="theme-link mb-2"><label class="m-0 text-mode">Tags:</label> <a
                                    href="#">Fashion</a>, <a href="#">Women</a>, <a href="#">Winter</a>
                            </p>
                            <p class="theme-link m-0"><label class="m-0 text-mode">Share:</label> <a
                                    ...
                                    href="#"><i class="bi bi-twitter"></i> </a><a
                                    class="icon icon-sm icon-secondary me-2" href="#"><i
                                        class="bi bi-instagram"></i> </a><a class="icon icon-sm icon-secondary me-2"
                                    href="#"><i class="bi bi-linkedin"></i></a></p>
                        </div>
                        <div class="pt-4"><img class="img-fluid"
                                src="{{ asset('frontend/assets/img/fashion/payment-details.png') }}" title=""
                                alt=""></div><!-- More Details -->
                        <div class="product-detail-collapse">
                            <div class="pd-collapse-row"><a class="pd-collapse-h5" data-bs-toggle="collapse"
                                    ...
                                    aria-controls="pd_description">Description <i class="bi bi-chevron-up"></i></a>
                            ...
                            <div class="pd-collapse-row"><a class="pd-collapse-h5" data-bs-toggle="collapse"
                                    ...
                                    aria-controls="pd_information">Information <i class="bi bi-chevron-up"></i></a>
                            ...
                            <div class="pd-collapse-row"><a class="pd-collapse-h5" data-bs-toggle="collapse"
                                    ...
                                    aria-controls="pd_review">Reviews <i class="bi bi-chevron-up"></i></a>
                                <div class="collapse" id="pd_review">
                                    <div class="pd-collapse-box">
                                        <div class="row align-items-end">
                                            <div class="col-sm-6">
                                                <div class="rating-star small"><i
                                                        class="bi small bi-star-fill active"></i> <i
                                                        class="bi small bi-star-fill active"></i> <i
                                                        class="bi small bi-star-fill active"></i>
                                                    <i class="bi small bi-star-fill active"></i> <i
                                                        class="bi small bi-star"></i> <span>4.85/5
                                                        (400 Reviews)</span>
                                                </div>
                                            </div>
                                            <div class="col-sm-6 text-sm-end"><a href="#" class="me-4">View
                                                    all</a> <a data-bs-toggle="collapse" href="#pd_add_review"
                                                    role="button" aria-expanded="false"
                                                    aria-controls="pd_add_review">Write a review</a></div>
                                            <div class="col-12 collapse" id="pd_add_review">
                                                <div class="my-4 p-3 bg-gray-100 border">
                                                    <form>
                                                        <div class="row g-2">
                                                            <div class="col-sm-6"><label class="form-label">Name</label>
                                                                <input type="text" name="name"
                                                                    class="form-control form-control-sm">
                                                            </div>
                                                            <div class="col-sm-6"><label class="form-label">Email</label>
                                                                <input type="text" name="email"
                                                                    class="form-control form-control-sm">
                                                            </div>
                                                            <div class="col-sm-12"><label
                                                                    class="form-label m-0 pe-3 w-100">Rating</label>
                                                            ...
                                                            <div class="col-sm-12"><label class="form-label">Review
                                                                    Title</label> <input type="text" name="review"
                                                                    class="form-control form-control-sm"></div>
                                                            <div class="col-sm-12"><label class="form-label">Body of
                                                                    Review (1500)</label>
                                                                <textarea rows="5" class="form-control"></textarea>
                                                            </div>
                                                            <div class="col-sm-12 pt-2"><button
                                        ...
                                        <div class="d-flex review-box border-top mt-3 pt-3">
                                            <div>
                                                <div class="review-image sm"><img class="img-fluid"
                                            ...
                                            <div class="col ps-3">
                                                ...
                                                <div class="rating-star small"><i
                                                        ...
                                                        class="bi small bi-star-fill active"></i>
                                                    <i class="bi small bi-star-fill active"></i> <i
                                                        class="bi small bi-star"></i> <span>13
                                                        April 2012</span>
                                                </div>
                                                <p class="m-0 pt-2 small">Lorem ipsum dolor sit amet, consectetur
    ...
    @include('frontend.site.related-product')
@endsection
